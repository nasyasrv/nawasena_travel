                ...
                @foreach ($rent as $car)
                    <div class="card">
                        ...
                        <div class="card-description">
                            ...
                            <p>
                                <i class="fa {{ $car->include_driver ? 'fa-check-circle text-success' : 'fa-times-circle text-danger' }}"></i>
                                Include Mobil + Driver <br>
                                <i class="fa {{ $car->excellent_service ? 'fa-check-circle text-success' : 'fa-times-circle text-danger' }}"></i>
                                Excellent Service (VVIP) <br>
                                <i class="fa {{ $car->include_fuel ? 'fa-check-circle text-success' : 'fa-times-circle text-danger' }}"></i>
                                termasuk BBM <br>
                                <i class="fa {{ $car->include_toll ? 'fa-check-circle text-success' : 'fa-times-circle text-danger' }}"></i>
                                termasuk Tol & Parkir
                            </p>
